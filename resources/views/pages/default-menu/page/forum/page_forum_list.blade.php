...
@section('content')
    <main id="js-page-content" role="main" class="page-content">
        @include('inc.breadcrumb',['bcrumb' => 'bc_level_tiga','bc_1'=>'Page View','bc_2'=>'Forum'])
        <div class="subheader">
            @component('inc.subheader',['subheader_title'=>'st_type_5'])
            @slot('sh_icon') plus-circle @endslot
            @slot('sh_titile_main') Forum: <span class='fw-300'>List</span> @endslot
            @slot('sh_descipt') Forum list page @endslot
            @endcomponent
        </div>
        <div class="row">
            <div class="col-xl-12">
