    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('inc.subheader',['subheader_title'=>'st_type_5'])
                ...
                @slot('sh_titile_main') Light Gallery<sup class='badge badge-primary fw-500'>PREMIUM ADDON</sup> @endslot
                @slot('sh_descipt') This particular version is catered especially for SmartAdmin, therefore making it unique for your webapp. The plugin is 100% responsive, comes with many extensions, such as autoplay, fullscreen, hash, pager, thumbnail, and zoom. To top it all off, we have integrated jquery.mousehweel and justifiedGallery plugin for justified thumbnails and mousehweel controls. @endslot
            @endcomponent            
        </div>
