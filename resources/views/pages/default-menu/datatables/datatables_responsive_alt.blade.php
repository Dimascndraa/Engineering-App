...
@section('content')
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            ...
            @slot('sh_titile_main') DataTables: <span class='fw-300'>Responsive Alternative</span> <sup class='badge badge-primary fw-500'>ADDON</sup> @endslot
