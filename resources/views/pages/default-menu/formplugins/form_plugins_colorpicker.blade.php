    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('inc.subheader',['subheader_title'=>'st_type_5'])
                ...
                @slot('sh_titile_main') Color Picker <sup class='badge badge-primary fw-500'>ADDON</sup> @endslot
                @slot('sh_descipt') Bootstrap Colorpicker is a modular color picker plugin for Bootstrap @endslot
            @endcomponent            
        </div>
