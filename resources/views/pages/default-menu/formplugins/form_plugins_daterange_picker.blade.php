...
@section('content')
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            ...
            @slot('sh_titile_main') Date Range Picker<sup class='badge badge-primary fw-500'>ADDON</sup> @endslot
            @slot('sh_descipt') A JavaScript component for choosing date ranges, dates and times. @endslot
            @endcomponent
        </div>
