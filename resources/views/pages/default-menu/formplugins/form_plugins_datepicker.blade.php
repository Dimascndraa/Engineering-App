...
@section('content')
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            ...
            @slot('sh_titile_main') Date Picker<sup class='badge badge-primary fw-500'>ADDON</sup> @endslot
            @slot('sh_descipt') Bootstrap-datepicker provides a flexible datepicker widget in the Bootstrap style. @endslot
            @endcomponent
        </div>
